...
Pack CLI: HTTPS downloads/release only（禁止 --cli-root）.
...
CLI_ZIP_BASE = "https://www.simulationtoolkits.com/downloads/release"
...
def main() -> int:
    ...
    cli_url = f"{CLI_ZIP_BASE}/simdb_cli-{plat}-cp312.zip"
    print(
